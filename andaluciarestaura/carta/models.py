...
class Carta(models.Model):
    ...
    propietario = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE, related_name="producto")
...
class Productos(models.Model):
        ...
        carta = models.ForeignKey(Carta, null=True, on_delete=models.CASCADE)
