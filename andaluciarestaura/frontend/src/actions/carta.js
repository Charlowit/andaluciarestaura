...
export const uploadProducto = (producto, cif, is_primera) => (dispatch, getState) => {
    ...
    var ruta = null;
    if(cif != null){
        ruta = "/home/ubuntu/andaluciarestaura/andaluciarestaura/frontend/static/clientes/" + cif + "/" + producto.carta + "/" + producto.id + ".jpeg"
        if(is_primera){
            ruta = "/home/ubuntu/andaluciarestaura/andaluciarestaura/frontend/static/clientes/" + cif + "/" + producto.id + ".jpeg"
        } 
