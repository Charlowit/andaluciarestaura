...
export default connect(mapStateToProps, { updateEslogan, updateURL, updateNombreCarta, getCartaExpecifica, subirproducto, addCategoria, getCategorias, deleteproducto, deleteCategoria })(CartaPage);
