                                                                                ...
                                                                                <div className="container box" >
                                                                                    ...
                                                                                    <form>
                                                                                        ...
                                                                                        <div className="columns">
                                                                                            ...
                                                                                            <div className="column">
                                                                                                <div className="control buttons is-centered" style={{ marginTop: '20px' }}>
                                                                                                    <button className="button is-success" style={{ color: 'white', backgroundColor: '#bca466' }} onClick={e => this.onSubmitDeleteCategoria(e, this.state.clickedCategoria.id, this.state.clickedCategoria.carta)}>Si</button>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div className="column">
                                                                                                <div className="control buttons is-centered" style={{ marginTop: '20px' }}>
                                                                                                    <button className="button is-success" style={{ color: 'white', backgroundColor: '#bca466' }} onClick={e => this.borrarCategoria(e, this.state.clickedCategoria)}>No</button>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div className="column"></div>
